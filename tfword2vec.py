...
######################################################################################################################
    ...
    def generate_batch(self, batch_size, num_skips, skip_window):
        #global data_index #RWM made into property
...
######################################################################################################################
    ...
    def word2vec(self,vocabulary):
        # vocabulary = read_data(filename)
        # vocabulary is corpus
        ...
        # dictionary - map of words(strings) to their codes(integers)
        # reverse_dictionary - maps codes(integers) to words(strings)
        self.data, self.count, self.dictionary, self.reverse_dictionary = self.build_dataset(vocabulary,self.vocabulary_size)
